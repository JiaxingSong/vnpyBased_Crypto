...
class VtTickData(VtBaseData):
    ...
    def __init__(self):
        ...
        self.lastVolume = EMPTY_FLOAT # EMPTY_INT             # 最新成交量
        self.volume = EMPTY_FLOAT #EMPTY_INT                 # 今天总成交量
        self.openInterest = EMPTY_FLOAT #EMPTY_INT           # 持仓量
...
class VtBarData(VtBaseData):
    ...
    def __init__(self):
        ...
        self.volume = EMPTY_FLOAT #EMPTY_INT             # 成交量
        self.openInterest = EMPTY_FLOAT #EMPTY_INT       # 持仓量    
...
class VtTradeData(VtBaseData):
    ...
    def __init__(self):
        ...
        self.volume = EMPTY_FLOAT #EMPTY_INT                 # 成交数量
...
class VtOrderData(VtBaseData):
    ...
    def __init__(self):
        ...
        self.totalVolume = EMPTY_FLOAT#EMPTY_INT            # 报单总数量
        self.tradedVolume = EMPTY_FLOAT#EMPTY_INT           # 报单成交数量
...
class VtPositionData(VtBaseData):
    ...
    def __init__(self):
        ...
        self.position = EMPTY_FLOAT#EMPTY_INT               # 持仓量
        self.frozen = EMPTY_FLOAT#EMPTY_INT                 # 冻结数量
        self.price = EMPTY_FLOAT                # 持仓均价
        self.vtPositionName = EMPTY_STRING      # 持仓在vt系统中的唯一代码，通常是vtSymbol.方向
        self.ydPosition = EMPTY_FLOAT#EMPTY_INT             # 昨持仓
...
class VtContractData(VtBaseData):
    ...
    def __init__(self):
        ...
        self.size = EMPTY_FLOAT#EMPTY_INT                   # 合约大小
